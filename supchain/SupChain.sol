...
contract Supchain is ERC20, Ownable(msg.sender)
{
    string constant TOKEN_NAME = "Supchain";
    string constant TOKEN_SYMBOL = "SUPC";
    ...
    constructor(address router) ERC20(TOKEN_NAME, TOKEN_SYMBOL) {
        ...
        _pair = IFactory(_router.factory())
         ...
         super._mint(owner(), TOTAL_SUPPLY);
    ...
    function _update(address from, address to, uint256 value) internal override {
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && _msgSender() != owner()) {
            if (!tradingEnabled) {
    ...
    */
    function allocateTokens(
        ...
        require(balanceOf(owner()) == TOTAL_SUPPLY, "Already allocated");
        ...
        //transfer(owner(), TOTAL_SUPPLY * 15 / 1000);
