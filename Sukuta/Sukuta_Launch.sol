...
contract SUKUTA is ERC721A, Ownable, DefaultOperatorFilterer  {
  using SafeMath for uint256;
    ...
    uint256 public MAX_VIPWL_SUPPLY = 3000;
    uint256 public WL_PRICE = 0.15 ether;
    uint256 public VIPWL_PRICE = 0.15 ether;
    uint256 public PRICE = 0.17 ether;
    uint256 public giveawayLimit = 20;
    string public baseTokenURI;
    bool public whitelistSaleIsActive;
    bool public saleIsActive;
    address private wallet1 = 0x134aD2A1890Cd3D886B37fDE6D4c3e9Aa3E7cB6e; // Wallet 1 50% - This are just for test purposes
    address private wallet2 = 0x134aD2A1890Cd3D886B37fDE6D4c3e9Aa3E7cB6e; // Wallet 2 40% - This are just for test purposes
    address private wallet3 = 0x134aD2A1890Cd3D886B37fDE6D4c3e9Aa3E7cB6e; // Wallet 3 10% - This are just for test purposes
